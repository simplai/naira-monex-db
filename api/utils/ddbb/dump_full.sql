...
3	Score Shareholder Experience	\N	25	18	t	f	f
4	Score Business Stability	\N	27	19	t	f	f
...
9	Score Anual Inferred income	\N	t	f	1	1
10	Scores Profitability	\N	t	f	2	2
11	Score Economic Sector, ESG, Solvency, Score Solvency	\N	t	f	3	1
12	Score Profitability, Anual inferred Income, Liquid Pledge, Solvency, Score Solvency	\N	t	f	4	5
13	Score Sum Wallet 31, Liquid Pledge	\N	t	f	5	2
...
1	admin	admin	admin@naira.com	$2b$12$jWzdOyahOEftUcbZrsCP4./pb2i8yNWjXQhFKPaGncrKLgHEz74X6	t	f	2023-02-09 19:29:57.18395
\.
...
SELECT pg_catalog.setval('public.admin_condition_id_seq', 52, true);
...
SELECT pg_catalog.setval('public.creditapplication_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.pyme_express_indicator_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.reporting_indicator_id_seq', 24, true);
