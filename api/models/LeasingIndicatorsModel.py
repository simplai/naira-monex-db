...
class LeasingIndicator(db.Model):

    def __repr__(self):
        return '<LeasingIndicator %r>' % self.naira_id

    __tablename__ = "leasing_indicator"
    ...
    sum_wallet_more_31 = db.Column(db.Integer, unique=False, nullable=True)
    ...
    line_product = db.Column(db.Float, unique=False, nullable=True)
    ...
    score_sum_wallet_more_31 = db.Column(db.String, unique=False, nullable=True)
